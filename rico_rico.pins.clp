(definstances ingredient
	...
	([ricota_cheese] of Ingredient
		(ing-name "Ricota cheese")
		(ing-availability 0)
		(calories 174)
		(fat 13)
		(protein 11)
	...
	([red_curry_paste] of Ingredient
		(ing-name "Red curry paste")
		(ing-availability 0)
		(calories 129)
		(fat 0)
		(protein 14)
...
(definstances maincourse
	...
	([mediterranean_salad] of MainCourse
		...
		(dish-combination Vegetarian Gluten-free Vegan Spanish Italian French Gourmet Mediterranean Islamic)
		(dish-price 2.2)
	)
	...
	([vegan_sandwich] of MainCourse
		...
		(dish-classification Kosher Vegetarian Vegan Islamic Mediterranean Cold Vegetables Lactose-free Modern)
	...
	([kareraisu] of MainCourse
		...
		(dish-ingredients [rices] [carrot] [tofu] [onion] [potato] [oil] [curry] [salt])
	...
	([american_burguer] of MainCourse
		...
		(dish-classification American Hot Meet Lactose-free] [[pork] [onion] [garlic] [eggs] [salt] [pepper] [bread])
		(dish-ingredients American Hot Meet Lactose-free)
		(dish-combination 4)
	)

	([harira] of MainCourse
		(dish-name "Harira")
		(dish-classification Islamic Morrocan Lactose-Free Mediterranean Hot Soup Classical)
...
(definstances secondcourse
	([roast_pork_with_prunes] of SecondCourse
		...
		(dish-classification Italian Meat Hot Classical Gluten-free Lactose-free] [[oil] [garlic] [salt] [black_pepper] [pork] [red_wine] [prunes])
	...
	([coq_au_vin] of SecondCourse
		...
		(dish-ingredients [red_wine] [onion] [oil] [mushroom] [bacon] [butter] [chicken] [salt] [black_pepper] [wheat_flour] [carrots])
	...
	([spanish_omelette] of SecondCourse
		...
		(dish-ingredients [potato] [onion] [eggs] [black_pepper] [salt] [oil]] [Spanish Vegetarian Gluten-free Islamic Kosher Mediterranean)
	...
	([cabbage_roll] of SecondCourse
		...
		(dish-ingredients [cabbage] [onion] [beef] [pork] [salt] [black_pepper] [tomato_paste] [chicken_broth] [bread_crumbs])
	...
	([couscous_meatlof] of SecondCourse
		...
		(dish-classification Modern Turkey Hot Meat Modern Moroccan)
		(dish-ingredients [onion] [salt] [bacon] [tomato_paste] [brown_sugar] [black_pepper] [eggs] [couscous] [zucchini] [ground_turkey] [dijon_mustard])
	...
	([sweet_and_sour_aubergines] of SecondCourse
		...
		(dish-classification Vegan Vegetarian Mediterranean Lactose-free Modern Hot)
